        ...
        return new Promise(function (resolve, reject) {
            _this._objectInstance.addMarker(options, function (marker) {
                if (marker) {
                    ...
                    _this.get('_overlays').push(marker.getId());
                    _this.set(marker.getId(), overlay);
                    resolve(overlay);
                }
                else {
                    reject();
        ...
        return new Promise(function (resolve, reject) {
            _this._objectInstance.addMarkerCluster(options, function (markerCluster) {
                if (markerCluster) {
                    ...
                    _this.set(markerCluster.getId(), overlay);
                    resolve(overlay);
                }
                else {
                    reject();
        ...
        return new Promise(function (resolve, reject) {
            _this._objectInstance.addCircle(options, function (circle) {
                if (circle) {
                    ...
                    _this.get('_overlays').push(circle.getId());
                    _this.set(circle.getId(), overlay);
                    resolve(overlay);
                }
                else {
                    reject();
        ...
        return new Promise(function (resolve, reject) {
            _this._objectInstance.addPolygon(options, function (polygon) {
                if (polygon) {
                    ...
                    _this.get('_overlays').push(polygon.getId());
                    _this.set(polygon.getId(), overlay);
                    resolve(polygon);
                }
                else {
                    reject();
        ...
        return new Promise(function (resolve, reject) {
            _this._objectInstance.addPolyline(options, function (polyline) {
                if (polyline) {
                    ...
                    _this.get('_overlays').push(polyline.getId());
                    _this.set(polyline.getId(), overlay);
                    resolve(overlay);
                }
                else {
                    reject();
        ...
        return new Promise(function (resolve, reject) {
            _this._objectInstance.addTileOverlay(options, function (tileOverlay) {
                if (tileOverlay) {
                    ...
                    _this.get('_overlays').push(tileOverlay.getId());
                    _this.set(tileOverlay.getId(), overlay);
                    resolve(overlay);
                }
                else {
                    reject();
        ...
        return new Promise(function (resolve, reject) {
            _this._objectInstance.addGroundOverlay(options, function (groundOverlay) {
                if (groundOverlay) {
                    ...
                    _this.get('_overlays').push(groundOverlay.getId());
                    _this.set(groundOverlay.getId(), overlay);
                    resolve(overlay);
                }
                else {
                    reject();
